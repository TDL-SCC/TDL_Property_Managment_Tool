...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Create Guest Reservation') }}</div>
                ...
                <div class="form-group row">
                    ...
                    <form method="POST" action="{{ route('admin.create-customer-res.submit') }}">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-2"> 
                                <input id="middle_initial" 
                                       ...
                                       required autocomplete="middle name">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-4">
                                <input id="date_of_birth"
                                       ...
                                       required autocomplete="date of birth">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-4">
                                <input id="check_in_date" 
                                       type="date" 
                                       class="form-control @error('check_in_date') is-invalid @enderror" 
                                       name="check_in_date" 
                                       required autocomplete="check in date">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-4">
                                <input id="check_out_date"
                                       type="date"
                                       class="form-control @error('check_out_date') is-invalid @enderror" 
                                       name="check_out_date" 
                                       required autocomplete="check out date">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-3"> 
                                <input id="room_type"
                                       ...
                                       name="room_type" 
                                       required autocomplete="room type">
